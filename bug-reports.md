...
> **Contexto:** SauceDemo es una aplicación de práctica. Los siguientes hallazgos se reprodujeron con los usuarios de prueba que la propia aplicación ofrece y se documentan para demostrar el proceso de QA.
...
**Resultado actual:** el botón permanece como **Add to cart** y el árbol de accesibilidad no muestra ningún cambio en el contador ni en el botón.
